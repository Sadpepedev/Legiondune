...
import { MessageSquare, ArrowLeft, ExternalLink, Wallet, Users, ArrowUpRight } from 'lucide-react';
      ...
      <div className="max-w-[1200px] mx-auto">
        <div className="flex justify-between items-center mb-8">
          ...
          <Link
            ...
            className="inline-flex items-center px-4 py-2 bg-[#00ffee] text-black rounded hover:bg-[#37fffc] transition-colors shadow-[0_0_20px_rgba(0,255,238,0.2)] hover:shadow-[0_0_30px_rgba(0,255,238,0.4)]"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-8">
            <div className="glass-panel p-8 rounded-lg">
              <div className="flex items-center mb-6">
                ...
                />
                <div>
                  <h1 className="text-3xl font-bold text-[#00ffee] title-glow mb-2">{name}</h1>
              ...
              {description && (
                <p className="text-gray-300 bg-black/20 p-4 rounded-lg border border-[rgba(0,255,238,0.1)]">
                  {description}
                </p>
              )}
            </div>
            ...
            <div className="glass-panel p-8 rounded-lg">
              <h2 className="text-xl font-bold text-[#00ffee] mb-6">Token Metrics</h2>
              <div className="grid grid-cols-2 gap-6">
                <div className="space-y-4">
                  <div className="bg-black/20 p-4 rounded-lg border border-[rgba(0,255,238,0.1)]">
            ...
            {saleData && (
              <div className="glass-panel p-8 rounded-lg">
                <h2 className="text-xl font-bold text-[#00ffee] mb-6">Sale Data</h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div className="bg-black/20 p-6 rounded-lg border border-[rgba(0,255,238,0.1)]">
            ...
            <div className="glass-panel p-8 rounded-lg">
              <h2 className="text-xl font-bold text-[#00ffee] mb-6">Price Chart</h2>
          ...
          <div className="space-y-8">
            <div className="glass-panel p-6 rounded-lg">
              <h2 className="text-xl font-bold text-[#00ffee] mb-4">Links</h2>
            ...
            <div className="glass-panel p-6 rounded-lg">
              <h2 className="text-xl font-bold text-[#00ffee] mb-6">Community Sentiment</h2>
