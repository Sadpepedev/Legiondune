  ...
  useEffect(() => {
    ...
    class Particle {
      ...
      constructor() {
        ...
        this.connection = 150; // Connection radius
      }
      ...
      draw() {
        ...
        // Add glow effect
        ctx.shadowBlur = 15;
        ctx.shadowColor = this.color.replace('alpha', '1');
        ctx.fill();
        ctx.shadowBlur = 0;
      }
    }
    ...
    const particleCount = Math.min(50, (canvas.width * canvas.height) / 50000);
