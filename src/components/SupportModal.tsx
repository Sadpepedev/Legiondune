          ...
          <div className="relative p-6 pb-4">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-2xl font-bold bg-gradient-to-r from-[#00ffee] to-[#37fffc] bg-clip-text text-transparent">
                  Support Degion.xyz
                </h2>
              </div>
              <button
          ...
          <div className="p-6 pt-2 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="group relative overflow-hidden rounded-xl bg-gradient-to-r from-black/60 to-black/40 border border-[#00ffee]/20 p-4 transition-all duration-300 hover:border-[#00ffee]/40 hover:shadow-[0_0_30px_rgba(0,255,238,0.1)]">
                ...
                <h3 className="text-lg font-semibold text-[#00ffee] mb-3">EVM Compatible Chains</h3>
                <div className="relative flex items-center">
                  ...
                  />
                  <button
                    onClick={() => navigator.clipboard.writeText('0x62f1f6bfe3a798d5023608ac0a9c8a9538276283')}
                    className="absolute right-2 px-2 py-1 text-xs text-[#00ffee] hover:text-[#37fffc] transition-colors"
                  >
                    Copy
                  </button>
                </div>
